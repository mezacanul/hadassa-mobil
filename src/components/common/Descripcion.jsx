...
export default function Descripcion({ cita }) {
    return (
        <VStack w={"100%"} alignItems={"start"} gap={"1.5rem"}>
            <Heading>Descripción:</Heading>
            <Textarea p={"1rem"} value={lorem} placeholder="Añade una descripción..." borderColor={"pink.500"} borderWidth={"2px"} fontSize={"1rem"} h={"17rem"} />
